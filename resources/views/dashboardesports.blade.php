		...
		<div class="container">
			<div class="">
				<div class="banner-content text-center">
					<h4 class="fw-normal theme-color mb-4">WELCOME TO</h4>
	
					<p>ESPORTS BROADCASTING PACKAGE</p>
					<a href="" class="default-button reverse-effect" data-rel="lightcase"><span>CONTINUE <i class="icofont-play-alt-1"></i></span> </a>
				</div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="footer-bottom-content text-center">
                            <p>&copy;2023 <a href="https://gadgets.mobcr3atives.com/">MOB GADGETS</a> GET PREMIUM GADGETS HERE </p>
                        </div>
                    </div>
                </div>
            </div>
